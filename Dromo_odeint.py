...
def main():
    ...
    # St = odeint( dromo_basic, S0, tspan, args=(None, ) )
    # np.savetxt("/Users/utente73/Desktop/res_Dromo_keplerian.txt", St)
    ...
    # print(list_of_lists)
    # a, e, i, RAAN, omega, theta = map(list, zip(*list_of_lists))
    # print(orbel_array)
    # print(np.hsplit(list_of_lists, 6))
    # print(np.shape(a))
